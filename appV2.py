...
moving_sphere = vp.sphere(pos=vp.vector(x_data[0], y_data[0], z_data), radius=10, color=vp.color.cyan)
...
for i in range(len(x_data)):
    ...
    moving_sphere.pos = vp.vector(x_data[i], y_data[i], z_data)           #Updating the cyan sphere position
