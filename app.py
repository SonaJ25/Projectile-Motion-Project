...
ax2.plot(time_data, Ax_data, label="Ax", color="blue")
ax2.plot(time_data, Ay_data, label="Ay", color="red")
...
ax3.plot(time_data, Vx_data, label="Vx", color="blue")
ax3.plot(time_data, Vy_data, label="Vy", color="red")
